...
{ 
    ...
    public string AddPerson()
    {
        ...
        comm.CommandText = "INSERT INTO Web-People (FName, LName, Street1, Street2, City, State, Zipcode, Birthday, Anniversary, HomePhone, WorkPhone, CellPhone, Email, CardWorthy, Relationship, Notes) VALUES (@FName, @LName, @Street1, @Street2, @City, @State, @Zipcode, @Birthday, @Anniversary, @HomePhone, @WorkPhone, @CellPhone, @Email, @CardWorthy, @Relationship, @Notes)";
